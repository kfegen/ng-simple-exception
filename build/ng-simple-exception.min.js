(function () {
  ...
  angular.module('simpleException', []).provider('simpleExceptionConfig', function () {
...
(function () {
  ...
  angular.module('simpleExceptionInterceptor', ['simpleException']).config(['$httpProvider', '$provide', function ($httpProvider, $provide) {
